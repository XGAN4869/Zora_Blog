...
import GithubActivityPanel from '~/components/profile/GithubActivityPanel.vue'
import ResumeVersionSwitcher from '~/components/resume/ResumeVersionSwitcher.vue'
import { defaultResumeVersion, resumeVersions } from '~/shared/resume/resume-data'

const activeVersionId = ref(defaultResumeVersion.id)

const resumeVersion = computed(() => {
  return resumeVersions.find(version => version.id === activeVersionId.value) ?? defaultResumeVersion
})

useSeoMeta({
  title: () => `${resumeVersion.value.pageTitle} | 甘林涵`,
  description: () => resumeVersion.value.pageDescription,
})
</script>
...
<template>
  ...
  >
    <div class="resume-layout">
      ...
      <div class="resume-layout__content">
        ...
        <section class="resume-section">
          <LazyProfileQuoteCard
            hydrate-on-visible
            :eyebrow="resumeVersion.quote.eyebrow"
            :title="resumeVersion.quote.title"
            :description="resumeVersion.quote.description"
          />
        </section>
      </div>
    </div>
